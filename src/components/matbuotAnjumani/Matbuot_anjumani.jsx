...
export default function MatbuotAnjumani() {
  ...
  const { data, error, isLoading } = useQuery(["tv", "/televediniye"], () =>
  ...
  return (
    <div className=" ">
      <div>
        <h2 className="font-semibold text-xl">Matbuot Anjumanlari</h2>
      </div>
      <form onSubmit={handleSubmit(handleTakeValueForm)}>
        <div className="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
          ...
          <div className="sm:col-span-3">
            ...
            >
              OTM rahbar xodimlarining ishtiroki
            </label>
            <Select
