...
export default function MessengersJSAdmin() {
              ...
              <div className={`w-full  `}>
                <div>
                  <h2 className="text-base font-semibold leading-7 text-gray-900 dark:text-white md:text-xl">
                    ...
                    <span className="uppercase">
                      Ijtimoiy tarmoq va messenjerlar
                    </span>
                  </h2>
                </div>
                <div className="md:mt-5 grid grid-cols-1 gap-x-6 md:gap-y-2 sm:gap-y-2 sm:grid-cols-6 ">
                  <div className="sm:col-span-3">
                    <Form.Item
                      name="showedUser"
                      label="Ijtimoiy tarmoq va messenjerlarda E’lon qilingan material muallifi/ishtirokchisining F.I.O"
                      rules={[
                        {
                          required: true,
                          message:
                            "Iltimos Ijtimoiy tarmoqlar  chiqishini kiriting!",
                        },
                      ]}
                    >
