...
export default function MessengerJSDashboard() {
  ...
  useEffect(() => {
    if (location.pathname === "/superadminpanel/messenger_dashboard") {
  ...
  const dataTable = postData
    ?.map((item, index) => {
      ...
      if (type !== "Ijtimoiy tarmoq va messengerlar") {
  ...
  const linkTo = locationRole ? "/superadminpanel/messenger" : "/messenger";
