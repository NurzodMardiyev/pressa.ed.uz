...
export default function InternetSitesJSDashboard() {
  ...
  useEffect(() => {
    if (location.pathname === "/superadminpanel/internet_sites_dashboard") {
  ...
  const linkTo = locationRole
    ? "/superadminpanel/internet_sites"
    : "/internet_sites";
